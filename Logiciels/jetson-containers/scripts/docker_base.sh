...
#BASE_IMAGE="registry.me:5000/l4t-base:r$L4T_VERSION"
#BASE_DEVEL="registry.me:5000/nvidia-l4t-base:r$L4T_VERSION"
...
if [ $L4T_RELEASE -eq 32 ]; then
	if [ $L4T_REVISION_MAJOR -eq 4 ]; then
		...
		if [ $L4T_REVISION_MINOR -eq 1 ]; then
			...
			#BASE_IMAGE="registry.me:5000/l4t-base:r32.5.0"
