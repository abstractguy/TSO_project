...
# File:        software/jetson/camera/ArduCam_Py_Demo.py
# By:          Samuel Duclos
# For:         Myself
# Usage:       python3 ArduCam_Py_Demo.py --config-file-name ./Config/USB2.0_UC-391_Rev.D/AR0134_RAW_8b_1280x964_31fps.cfg
# Description: This file is for testing streaming using the Arducam Camarray Shield on an Nvidia Jetson Nano.


import argparse, cv2, json, numpy as np, os, signal, sys, threading, time
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Simple Arducam streaming test.', 
