...
# File:        software/jetson/utils/arducam_config_parser/arducam_config_parser.py
# By:          Samuel Duclos
# For:         Myself
# Description: This file defines low-level I2C functions for Arducam Camarray cameras control.
# Reference:   https://github.com/ArduCAM/arducam_config_parser
...
try:
    ...
    print("libarducam_config_parser load failed.")
    print("Please make sure you have arducam_config_parser installed.")
...
def LoadConfigFile(name):
    ...
    if parse(filename, byref(cfgs)) != 0:
        raise RuntimeError("Failed loading configuration file {}.".format(name))
    return cfgs
