...
*/
...
#ifdef DISABLE_SERVO_INTERCEPT
	#define SERVO_0_INTERCEPT 0.0
	#define SERVO_1_INTERCEPT 0.0
	#define SERVO_2_INTERCEPT 0.0
	#define SERVO_3_INTERCEPT 0.0
#else
...
#ifdef DISABLE_SERVO_SLOPE
	#define SERVO_0_SLOPE 0.0
	#define SERVO_1_SLOPE 0.0
	#define SERVO_2_SLOPE 0.0
	#define SERVO_3_SLOPE 0.0
#else
	...
	#define SERVO_0_MANUAL 0.0
	#define SERVO_1_MANUAL 0.0
	#define SERVO_2_MANUAL 0.0
