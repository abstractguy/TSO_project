...
#              Implementation: https://github.com/adafruit/Adafruit_CircuitPython_VL6180X.git
...
class VL6180X:
    """Mandatory parameters:
           <i2v>:     I2C bus instance to connect to.
       Optional parameters:
    ...
    def _load_settings(self):
        ...
        # Recommended : Public registers - See datasheet for more details.
        self._write_8(0x0011, 0x10) # Enables polling for 'New Sample ready'.

        # When measurement completes.
        self._write_8(0x010A, 0x30) # Set the averaging sample period (compromise between lower noise and increased execution time).
        self._write_8(0x003F, 0x46) # Sets the light and dark gain (upper nibble). Dark gain should not be changed.
        self._write_8(0x0031, 0xFF) # Sets the # of range measurements after which auto calibration of system is performed.
        self._write_8(0x0040, 0x63) # Set ALS integration time to 100ms.
        self._write_8(0x002E, 0x01) # Perform a single temperature calibration of the ranging sensor.

        # Optional: Public registers - See datasheet for more info.
        self._write_8(0x001B, 0x09) # Set default ranging inter-measurement period to 100ms.
        self._write_8(0x003E, 0x31) # Set default ALS inter-measurement period to 500ms.
        self._write_8(0x0014, 0x24) # Configures interrupt on 'New Sample Ready threshold event'.
